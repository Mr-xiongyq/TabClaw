...
- **[2026-04-02]** **兼容 ClawdHub 等平台提供的 skill 包：** 以 `SKILL.md` 为主的压缩包（例如从 [ClawdHub](https://clawdhub.com) 下载）可直接导入——在侧栏 **Skills** 中点击 **📦 Import** 上传 `.zip`，即可将指令型技能注入智能体上下文；可在列表中随时启用/禁用或删除。
